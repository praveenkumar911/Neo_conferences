...
const Events = () => {
  ...
  return (
    <div>
      <div class="chventsoverlay">
        <div class="chventsoverlay-text">
        <h1>4th International Congress of Women Changemakers and Visionary Leaders  </h1> 
          <div class="chvent-details">
          ...
          <div class="chutton-group">
            <button class="chvent-button">Brochure</button>
            <button class="chvent-button">Abstract</button>
          </div>
        </div>
        <div class="chountdown-container">
          <div class="chountdown-timer">
            <div class="chime-box"><span>{timeLeft.days}</span><span>Days</span></div>
            <div class="chime-box"><span>{timeLeft.hours}</span><span>Hours</span></div>
            <div class="chime-box"><span>{timeLeft.minutes}</span><span>Minutes</span></div>
            <div class="chime-box"><span>{timeLeft.seconds}</span><span>Seconds</span></div>
          </div>
        </div>
      </div>
