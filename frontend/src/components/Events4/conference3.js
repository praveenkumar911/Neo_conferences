...
const OverlayPage = () => {
  ...
  return (
    <div>
      <div class="miventsoverlay">
        <div class="miventsoverlay-text">
          <h1>4th International Congress on Women's Health and Midwifery Excellence</h1>
          <div class="mivent-details">
          ...
          <div class="miutton-group">
            <button class="mivent-button">Brochure</button>
            <button class="mivent-button">Abstract</button>
          </div>
        </div>
        <div class="miountdown-container">
          <div class="miountdown-timer">
            <div class="miime-box"><span>{timeLeft.days}</span><span>Days</span></div>
            <div class="miime-box"><span>{timeLeft.hours}</span><span>Hours</span></div>
            <div class="miime-box"><span>{timeLeft.minutes}</span><span>Minutes</span></div>
            <div class="miime-box"><span>{timeLeft.seconds}</span><span>Seconds</span></div>
          </div>
        </div>
      </div>
      ...
      <div className="miconference-details">
        ...
        <div className="mitext-container">
          ...
          <p>
          The 4th International Congress on Women's Health and Midwifery Excellence, hosted by Neo Conferences, presents a unique opportunity for individuals from diverse backgrounds and disciplines to come together, share insights, and explore the interconnectedness of mind, body, and spirit. 
          </p>
