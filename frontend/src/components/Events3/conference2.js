      ...
      <div className="spoverlay-cont">
        <div className="spoverlay-text">
          ...
          <div className="spbutton-group">
            <button  className="spevent-button" >  Brochure </button>
        ...
        <div className="spcountdown-container">
          <div className="spcountdown-timer">
            <div className="sptime-box"> <span>{timeLeft.days}</span> <span>Days</span> </div>
            <div className="sptime-box"> <span>{timeLeft.hours}</span> <span>Hours</span> </div>
            <div className="sptime-box"> <span>{timeLeft.minutes}</span> <span>Minutes</span> </div>
            <div className="sptime-box"> <span>{timeLeft.seconds}</span> <span>Seconds</span> </div>
          </div>
        </div>
      </div>
