...
const OverlayPage = () => {
  ...
  useEffect(() => {
    const eventDate = new Date('2026-10-16T00:00:00');
  ...
  return (
    <div>
      <div class="nmiventsoverlay">
        <div class="nmiventsoverlay-text">
          <h1>6th World Congress on Mindfulness, Psychology, and Spirituality</h1>
          <div class="nmivent-details">
        ...
        <div class="nmiountdown-container">
          <div class="nmiountdown-timer">
            <div class="nmiime-box"><span>{timeLeft.days}</span><span>Days</span></div>
            <div class="nmiime-box"><span>{timeLeft.hours}</span><span>Hours</span></div>
            <div class="nmiime-box"><span>{timeLeft.minutes}</span><span>Minutes</span></div>
            <div class="nmiime-box"><span>{timeLeft.seconds}</span><span>Seconds</span></div>
          </div>
        </div>
      </div>
      ...
      <div className="miconference-details">
        ...
        <div className="mitext-container">
          ...
          <p>
          The 6th World Congress on Mindfulness, Psychology, and Spirituality, hosted by Neo Conferences, presents a unique opportunity for individuals from diverse backgrounds and disciplines to come together, share insights, and explore the interconnectedness of mind, body, and spirit. 
          </p>
