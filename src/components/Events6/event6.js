    ...
    <div>
      <div class="rdventsoverlay">
        ...
        <h1>4th Global Congress on Women’s Leadership, Empowerment, and Sustainable Development </h1> 
          ...
          <div class="rdutton-group">
            <button class="rdvent-button">Brochure</button>
            <button class="rdvent-button">Abstract</button>
          </div>
        </div>
        <div class="rdountdown-container">
          <div class="rdountdown-timer">
            <div class="rdime-box"><span>{timeLeft.days}</span><span>Days</span></div>
            <div class="rdime-box"><span>{timeLeft.hours}</span><span>Hours</span></div>
            <div class="rdime-box"><span>{timeLeft.minutes}</span><span>Minutes</span></div>
            <div class="rdime-box"><span>{timeLeft.seconds}</span><span>Seconds</span></div>
          </div>
        </div>
      </div>
