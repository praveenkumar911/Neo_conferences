...
const Events = () => {
  ...
  return (
    <div>
      <div className="eventsover">
        ...
        <div className="countdown-container">
          <div className="countdown-timer">
            <div className="time-box"> <span>{timeLeft.days}</span> <span>Days</span> </div>
            <div className="time-box"> <span>{timeLeft.hours}</span> <span>Hours</span> </div>
            <div className="time-box"> <span>{timeLeft.minutes}</span> <span>Minutes</span> </div>
            <div className="time-box"> <span>{timeLeft.seconds}</span> <span>Seconds</span> </div>
          </div>
        </div>
      </div>
      ...
      <div className="newscientific-sessions">
        <h1>Sessions/Topics</h1>
        <div className="newscientific-card-container">
          <div className="newscientific-card">
