...
const Events = () => {
  ...
  useEffect(() => {
    const eventDate = new Date('2026-10-15T00:00:00');
  ...
  : null;
    ...
    link.href =file;
    link.download = '7th-International-Congress-Womens-Leadership-Brochure.pdf';
  ...
  return (
    <div>
      <div class="apeventsoverlay">
        <div class="apeventsoverlay-text">
        <h1>7th Global Women Power Summit on the Dynamics of Leadership </h1>
          <div class="apevent-details">
            <div><i class="fa-solid fa-calendar-alt exicon"></i> October 15-16, 2026</div>
        ...
        <div class="apcountdown-container">
          <div class="apcountdown-timer">
            <div class="aptime-box"><span>{timeLeft.days}</span><span>Days</span></div>
            <div class="aptime-box"><span>{timeLeft.hours}</span><span>Hours</span></div>
            <div class="aptime-box"><span>{timeLeft.minutes}</span><span>Minutes</span></div>
            <div class="aptime-box"><span>{timeLeft.seconds}</span><span>Seconds</span></div>
          </div>
        </div>
      </div>

      <div className="APnewconferences-details">
            <div className="APnewconfimage-container">
                <img src={require('../newconference1/conf.jpg')} alt="APnewConference" />
            </div>
            <div className="APnewconftext-container">
                <h2>About the Conference</h2>
                <p> 7th Global Women Power Summit on the Dynamics of Leadership Hosted by NEO Conferences Join us for the 7th Global Women Power Summit on the Dynamics of Leadership, taking place on October 15-16, 2026, in NewYork, USA. This summit provides a unique opportunity for leaders, professionals, researchers, and advocates from various backgrounds and cultures to engage, collaborate, and explore vital topics in women’s leadership and empowerment.
                  <strong> Theme: "Women's Voices, Women's Power: Toward a Vision of Women Leadership"   </strong>.</p>
                <p> The summit serves as an inspiring platform to address key issues such as leadership development, economic empowerment, gender equality, and the role of women in shaping policy and driving innovation across sectors. It also aims to foster discussions around strategies for overcoming barriers to leadership, mentorship and sponsorship, and the importance of building inclusive leadership cultures globally. </p>
                <p>  By participating in this event, you’ll have the opportunity to share your expertise, success stories, and innovative ideas with a diverse community of change-makers committed to advancing women's leadership worldwide.</p>
                <p> We invite you to be part of this inclusive platform to contribute to dynamic discussions, spark collaborations, and make a significant impact on the future of women’s leadership. Join the movement toward a more equitable, empowered future for all!  </p>
            </div>
      </div>


      <div className="APscientific-newconferences">
            <h1>Sessions/Topics</h1>
            <div className="APscientific-newconferences-card">
            <div className="APscientific-newcard">
            ...
            <div className="APnewvenue-confsection">
                <h2>Venue</h2>
                <p>NewYork, USA </p>
            </div>
      </div>
      
      <div className="APnewconfscientific-agenda">
            <h2>Scientific Agenda</h2>
            <div className="APnewconfday-buttons">
        ...
        <table className="APnewconferenceschedule">
            <thead>
                    <tr>
                    <th>Time</th>
                    <th>Speaker</th>
