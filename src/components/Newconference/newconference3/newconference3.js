...
const Events = () => {
  ...
  return (
    <div>
      <div class="ventsoverlay">
        <div class="ventsoverlay-text">
        <h1>6th Global Women Power Summit on the Dynamics of Leadership</h1>
        ...
        <div class="ountdown-container">
          <div class="ountdown-timer">
            <div class="ime-box"><span>{timeLeft.days}</span><span>Days</span></div>
            <div class="ime-box"><span>{timeLeft.hours}</span><span>Hours</span></div>
            <div class="ime-box"><span>{timeLeft.minutes}</span><span>Minutes</span></div>
            <div class="ime-box"><span>{timeLeft.seconds}</span><span>Seconds</span></div>
          </div>
        </div>
      </div>

      <div className="newconference-overview">
        <div className="newimage-overview">
        ...
        <div className="confnewtext-overview">
          ...
          <p>
          Join us for the 6th Global Women Power Summit on the Dynamics of Leadership, hosted by Neo Conferences, on March 08-09, 2026, in Paris, France. This dynamic event offers a transformative platform for women from all walks of life to engage, collaborate, and drive progress on issues impacting their personal and professional spheres.
      ...
      <div className="conference-Topics">
        ...
        <div className="newTopics-card-container">
          <div className="newTopics-card">
      ...
      <div className="new-agenda-section">
        <h2>Scientific Agenda</h2>
        <div className="conferenceday-buttons">
        ...
        <table className="conference-section-table">
          <thead>
            <tr>
              <th>Time</th>
              <th>Speaker</th>
