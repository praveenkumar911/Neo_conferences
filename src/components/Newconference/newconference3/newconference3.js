...
const Events = () => {
  ...
  return (
    <div>
      <div className="eventOverview">
        <div className="eventOverlayText">
          ...
          >
            ...
            <button className="eventButton">Abstract</button>
            </div>
        </div>
      ...
      <section className="registration-carai">
        <div className="intro-carai">
          <h1>Register Now!</h1>
          <p>
        ...
        <div className="registration-card-carai">
          <div className="registration-caraicard">
