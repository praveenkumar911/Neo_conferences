    ...
    <div>
      <div class="oldventsoverlay">
        ...
        <div class="oldountdown-container">
          <div class="oldountdown-timer">
            <div class="oldime-box"><span>{timeLeft.days}</span><span>Days</span></div>
            <div class="oldime-box"><span>{timeLeft.hours}</span><span>Hours</span></div>
            <div class="oldime-box"><span>{timeLeft.minutes}</span><span>Minutes</span></div>
            <div class="oldime-box"><span>{timeLeft.seconds}</span><span>Seconds</span></div>
          </div>
        </div>
      </div>
      ...
      <div className="newconferences-details">
            ...
            <div className="newconftext-container">
                ...
                <p>
                5th Global Women Power Summit on the Dynamics of Leadership Hosted by NEO Conferences
                Join us for the 5th Global Women Power Summit on the Dynamics of Leadership, taking place on October 9-10, 2025, in Toronto, Canada. This summit provides a unique opportunity for leaders, professionals, researchers, and advocates from various backgrounds and cultures to engage, collaborate, and explore vital topics in women’s leadership and empowerment.
