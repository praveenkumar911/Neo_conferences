...
const Events = () => {
  ...
  return (
    <div>
      <div className="newconferencesover">
        <div className="neweventsoverlay-text">
          <h1>4th Global Women Power Summit on the Dynamics of Leadership </h1> 
          <div className="newevent-details">
            <div className="newevent-date">
              <FaCalendarAlt className="new-icon" />
              <span>May 07-08, 2025</span>
            </div>
            <div className="newevent-location">
              <FaMapMarkerAlt className="new-icon" />
          ...
          >
            ...
            <button className="newevent-button">Abstract</button>
          </div>
        </div>

        <div className="newcountdown-container">
          <div className="newcountdown-timer">
      ...
      <section className="payment-carai">
        <div className="intro-payment">
          <h1>Register Now!</h1>
          <p>
        ...
        <div className="payment-card-carai">
          <div className="payment-caraicard">
