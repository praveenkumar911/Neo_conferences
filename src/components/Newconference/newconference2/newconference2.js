...
const Events = () => {
  ...
  const handleBrochureDownload = () => {
    ...
    link.href =file;
    link.download = '4th-International-Congress-Womens-Leadership-Brochure.pdf';
  ...
  return (
    <div>
      <div class="newventsoverlay">
        <div class="newventsoverlay-text">
          <h1>4th Global Women Power Summit on the Dynamics of Leadership</h1>
          <div class="newvent-details">
            <div><i class="fa-solid fa-calendar-alt exicon"></i> May 07-08, 2025</div>
            <div><i class="fa-solid fa-map-marker-alt exicon"></i> Toronto, Canada</div>
          </div>
          <div class="newutton-group">
            <button class="newvent-button" onClick={handleBrochureDownload} >Brochure</button>
            <button class="newvent-button">Abstract</button>
          </div>
        </div>
        <div class="newountdown-container">
          <div class="newountdown-timer">
            <div class="newime-box"><span>{timeLeft.days}</span><span>Days</span></div>
            <div class="newime-box"><span>{timeLeft.hours}</span><span>Hours</span></div>
            <div class="newime-box"><span>{timeLeft.minutes}</span><span>Minutes</span></div>
            <div class="newime-box"><span>{timeLeft.seconds}</span><span>Seconds</span></div>
          </div>
        </div>
      </div>

      <div className="newconference-details">
        <div className="newimage-container">
          <img src={require('./conf.jpg')}  alt="Conference" />
        </div>

        <div className="confnewtext-container">
          <h2>About the Conference</h2>
          <p>
          Join us for the 4th Global Women Power Summit on the Dynamics of Leadership, hosted by Neo Conferences, on May 07-08, 2025, in Toronto, Canada. This dynamic event offers a transformative platform for women from all walks of life to engage, collaborate, and drive progress on issues impacting their personal and professional spheres.
      ...
      <div className="conference-sessions">
        ...
        <div className="newconference-card-container">
          <div className="newconference-card">
        ...
        <div className="new-venue-section">
          <h2>Venue</h2>
          <p>Toronto, Canada</p>
        </div>
      </div>
      
      <div className="newconference-agenda">
        <h2>Scientific Agenda</h2>
        <div className="newday-buttons">
        ...
        <table className="newconference-table">
          <thead>
            <tr>
              <th>Time</th>
              <th>Speaker</th>
